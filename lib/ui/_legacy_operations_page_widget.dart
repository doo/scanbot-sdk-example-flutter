...
class LegacyPageOperations extends StatefulWidget {
  final sdk.Page initialPage;

  LegacyPageOperations(this.initialPage);

  @override
  _LegacyPageOperationsState createState() => _LegacyPageOperationsState();
}

class _LegacyPageOperationsState extends State<LegacyPageOperations> {
