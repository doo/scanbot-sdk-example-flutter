...
class MultiImageBarcodesResultPreviewWidget extends StatelessWidget {
                ...
                return Column(
                    children: [
                      ...
                      getImageContainer(
                          ...
                          context),
                      const SizedBox(height: 10),
                      SizedBox(child: getBoldTextWidget("Detected Barcodes"),
                          width: MediaQuery
                              .of(context)
                              .size
                              .width - 30),
  ...
  Widget getResultTitle(int position) {
    ...
    return SizedBox(width: 300,
        child: Text("Result $title", textAlign: TextAlign.left,
  ...
  Widget getBarcodeDescription(BarcodeItem item, BuildContext context) {
    var widget = SizedBox(width: MediaQuery
        .of(context)
        .size
        .width - 30,
        child: Row(children: [
          const SizedBox(width: 15),
          getBoldTextWidget(barcodeFormatEnumMap[item.barcodeFormat] ?? 'UNKNOWN'),
